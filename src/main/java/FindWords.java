...
public class FindWords {
    ...
    protected String URL_text;

    /** Поле словаря для статистики по словам */
    protected Map<String,Integer> words_in_topic_file = new HashMap<>();

    /** Поле файла с текстом */
    protected StringBuilder text_file = new StringBuilder();
     ...
     */
    private void Find_Same_Words_Download_Files() throws IOException {
